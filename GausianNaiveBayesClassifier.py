# Gaussian Naive Bayesian Classifier by Massimiliano Tomassoli (2013)

# You can download the data set from
#   http://www-stat.stanford.edu/~tibs/ElemStatLearn/data.html
# It's the last data set of the list.
# Unpack the archive somewhere and change 'main_dir' below.
...
main_dir = 'c:\\users\\kiuhnm\\desktop'
#=======================#
